<?php
    ...
    function switchRole($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/checkIfStaffHasSubjectAssigned/" . $id);
        ...
        if(!$data){
            ...
            $server_request = curl_init(SERVER_URL . "/api/v1/update/staff/" . $id);
    ...
    function deleteStaffMember($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/delete/staff/" . $id . "/" . ($_POST["oldRole_$id"] === "professor" ? "0" : "1"));
