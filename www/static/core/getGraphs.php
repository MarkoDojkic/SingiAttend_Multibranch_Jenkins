<?php
    ...
    $server_request = curl_init(SERVER_URL . "/api/v1/totalStudents/" . $_POST["subjectSelection"]);
    ...
    function getAttendanceData($xml, $totalStudents, $attendanceFor){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/getAll" . $attendanceFor . "/" . $_POST["subjectSelection"]);
