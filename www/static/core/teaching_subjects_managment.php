<?php
    ...
    function showDetails($id,$xml){
        $server_request = curl_init(SERVER_URL . "/api/v1/getSubject/" . $id);
    ...
    function startNewSubjectYear($id,$xml){
        $server_request = curl_init(SERVER_URL . "/api/v1/startNewSubjectYear/" . $id);
    ...
    function endCurrentSubjectYear($id,$xml){
        $server_request = curl_init(SERVER_URL . "/api/v1/endCurrentSubjectYear/" . $id);
    ...
    function editSubject($id,$xml){
        ...
        if($post != null){
            $server_request = curl_init(SERVER_URL . "/api/v1/update/subject/" . $id);
    ...
    function viewAttendingStudents($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/allStudentBySubjectId/" . $id);
    ...
    function viewLectures($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/subjectIsInactiveById/" . $id);
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/getAllLectures/" . $id);
    ...
    function startNewLecture($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/getLastLecture/" . $id);
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/insert/lecture/" . $id . "/" . $_POST['start_time'] . "/" . $_POST['end_time']);
    ...
    function viewExercises($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/getAllExercises/" . $id);
    ...
    function startNewExercise($id,$xml){
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/getLastExercise/" . $id);
        ...
        $server_request = curl_init(SERVER_URL . "/api/v1/insert/exercise/" . $id . "/" . $_POST['start_time'] . "/" . $_POST['end_time']);
